...
## ??? **IMPLEMENTAÇÕES CRÍTICAS PARA EXPANDIR**
...
- **GunDrawEvent.java** - MARCADO como pendente, mas REALMENTE habilitado
- **GunFinishReloadEvent.java** - MARCADO como pendente, mas REALMENTE habilitado
- **GunFireSelectEvent.java** - MARCADO como pendente, mas REALMENTE habilitado
- **GunMeleeEvent.java** - MARCADO como pendente, mas REALMENTE habilitado
- **GunReloadEvent.java** - MARCADO como pendente, mas REALMENTE habilitado
- **BonesItem.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CrosshairType.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CubesItem.java** - MARCADO como pendente, mas REALMENTE habilitado
- **GeometryModelLegacy.java** - MARCADO como pendente, mas REALMENTE habilitado
- **RenderConfig.java** - MARCADO como pendente, mas REALMENTE habilitado
- **RenderDistance.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AmmoBoxItemDataAccessor.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AmmoCountPapi.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AmmoItemDataAccessor.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AttachmentDataManager.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AttachmentDisplay.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AttachmentItemDataAccessor.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AttachmentItemRenderer.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AttachmentsTagManager.java** - MARCADO como pendente, mas REALMENTE habilitado
- **BedrockCubePerFace.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CameraAnimationObject.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CameraRotateListener.java** - MARCADO como pendente, mas REALMENTE habilitado
- **ChangeGunPropertyEvent.java** - MARCADO como pendente, mas REALMENTE habilitado
- **ClientConfig.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CommonAttachmentIndex.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CommonBlockIndex.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CommonBlockIndexSerializer.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CommonDataManager.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CommonGunIndex.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CommonGunIndexSerializer.java** - MARCADO como pendente, mas REALMENTE habilitado
- **CompatRegistry.java** - MARCADO como pendente, mas REALMENTE habilitado
- **ConstraintObject.java** - MARCADO como pendente, mas REALMENTE habilitado
- **ConstraintRotateListener.java** - MARCADO como pendente, mas REALMENTE habilitado
- **ConstraintTranslateListener.java** - MARCADO como pendente, mas REALMENTE habilitado
- **GltfManager.java** - MARCADO como pendente, mas REALMENTE habilitado
- **IClientPlayerGunOperator.java** - MARCADO como pendente, mas REALMENTE habilitado
- **ICommonResourceProvider.java** - MARCADO como pendente, mas REALMENTE habilitado
- **IGun.java** - MARCADO como pendente, mas REALMENTE habilitado
- **IGunOperator.java** - MARCADO como pendente, mas REALMENTE habilitado
- **InterpolatorUtil.java** - MARCADO como pendente, mas REALMENTE habilitado
- **KubeJSGunEventPoster.java** - MARCADO como pendente, mas REALMENTE habilitado
- **LaserColorUtil.java** - MARCADO como pendente, mas REALMENTE habilitado
- **LeftHandRender.java** - MARCADO como pendente, mas REALMENTE habilitado
- **ModelAdditionalMagazineListener.java** - MARCADO como pendente, mas REALMENTE habilitado
- **ModelTranslateListener.java** - MARCADO como pendente, mas REALMENTE habilitado
- **OculusCompat.java** - MARCADO como pendente, mas REALMENTE habilitado
- **PackInfoManager.java** - MARCADO como pendente, mas REALMENTE habilitado
- **RecipeFilter.java** - MARCADO como pendente, mas REALMENTE habilitado
- **RecipeFilterManager.java** - MARCADO como pendente, mas REALMENTE habilitado
- **RightHandRender.java** - MARCADO como pendente, mas REALMENTE habilitado
- **SlotModel.java** - MARCADO como pendente, mas REALMENTE habilitado
- **SoundManager.java** - MARCADO como pendente, mas REALMENTE habilitado
- **Spline.java** - MARCADO como pendente, mas REALMENTE habilitado
- **TextShowRender.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AmmoItemBuilder.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AttachmentItemBuilder.java** - MARCADO como pendente, mas REALMENTE habilitado
- **AttachmentRender.java** - MARCADO como pendente, mas REALMENTE habilitado
- **BeamRenderer.java** - MARCADO como pendente, mas REALMENTE habilitado
- **BedrockAnimatedModel.java** - MARCADO como pendente, mas REALMENTE habilitado
- **BedrockAttachmentModel.java** - MARCADO como pendente, mas REALMENTE habilitado
- **BedrockCubeBox.java** - MARCADO como pendente, mas REALMENTE habilitado
- **BedrockGunModel.java** - MARCADO como pendente, mas REALMENTE habilitado
- **BedrockModel.java** - MARCADO como pendente, mas REALMENTE habilitado
