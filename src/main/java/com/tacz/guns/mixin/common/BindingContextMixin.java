...
// TODO: Re-enable when ControllableInner.GunKeyConflict is implemented for NeoForge 1.21.1
...
public abstract class BindingContextMixin {
    ...
    private boolean controllableIsStupid(boolean original) {
        // TODO: Re-implement ControllableInner.GunKeyConflict for NeoForge 1.21.1
