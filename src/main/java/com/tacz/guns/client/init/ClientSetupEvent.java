...
import net.neoforged.fml.common.EventBusSubscriber;`r`nimport net.neoforged.fml.event.lifecycle.FMLClientSetupEvent;

import static net.neoforged.client.gui.overlay.VanillaGuiOverlay.CROSSHAIR;
